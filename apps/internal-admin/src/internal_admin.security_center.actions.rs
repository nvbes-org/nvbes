...
async fn revoke_mfa_factor_route(
    ...
    require_operator_permission_headers(&headers, BackofficePermission::SecurityMutate)?;
...
pub(crate) fn validate_security_action_reason(reason: &str) -> Result<(), AppError> {
