...
#[tokio::test]
async fn revoke_break_glass_rejects_generic_confirmation_and_audits_success() {
...
async fn governance_schema_exists(pool: &PgPool) -> bool {
...
async fn seed_break_glass_account(pool: &PgPool, actor_id: Uuid, principal_id: Uuid) -> Uuid {
