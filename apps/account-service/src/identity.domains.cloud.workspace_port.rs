...
#[path = "identity.domains.cloud.workspace_port.invitations.rs"]
mod workspace_port_invitations;
#[path = "identity.domains.cloud.workspace_port.mutations.rs"]
mod workspace_port_mutations;
#[path = "identity.domains.cloud.workspace_port.parse.rs"]
mod workspace_port_parse;
#[path = "identity.domains.cloud.workspace_port.types.rs"]
mod workspace_port_types;
#[path = "identity.domains.cloud.workspace_port.workspaces.rs"]
