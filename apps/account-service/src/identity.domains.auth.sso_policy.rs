...
pub async fn ensure_password_allowed_for_email(db: &PgPool, email: &str) -> Result<(), AppError> {
...
fn validate_sso_domain(domain: &str) -> Result<(), AppError> {
