...
use nvbes_billing::timestamp_field;
use serde_json::Value;

pub fn ensure_subscription_update_consistency(object: &Value) -> Result<(), AppError> {
...
pub fn ensure_subscription_price_consistency(object: &Value) -> Result<(), AppError> {
    let price_id = object
...
pub fn ensure_subscription_item_consistency(object: &Value) -> Result<(), AppError> {
...
pub fn ensure_subscription_quantity_consistency(object: &Value) -> Result<(), AppError> {
    let quantity = object
...
pub fn ensure_subscription_deleted_consistency(
    ...
    super::validators_workspace::ensure_subscription_workspace_consistency(object, workspace_id)?;
    let status = object.get("status").and_then(Value::as_str);
