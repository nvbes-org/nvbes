...
pub(crate) struct BillingPlatformActionInput {
    pub(crate) action_kind: &'static str,
    pub(crate) routing_rule_id: Option<Uuid>,
    pub(crate) kyc_profile_id: Option<Uuid>,
    pub(crate) einvoicing_profile_id: Option<Uuid>,
...
pub(crate) async fn insert_action(
    ...
    workspace_id: Uuid,
    input: BillingPlatformActionInput,
    ...
    sqlx::query_scalar::<_, Uuid>(
        "INSERT INTO internal_admin_billing_platform_actions (
           ...
           kyc_profile_id, einvoicing_profile_id, previous_state, next_state, reason, metadata
    ...
    .bind(input.kyc_profile_id)
    .bind(input.einvoicing_profile_id)
...
pub(crate) async fn insert_audit(
    ...
    sqlx::query(
        "INSERT INTO audit_events (
           ...
           $1, $2, $3, $4, $5, $6,
           jsonb_build_object('billing_platform_action_id', $7) || $8::jsonb,
