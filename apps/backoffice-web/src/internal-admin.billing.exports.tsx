...
import { downloadBillingExport } from './internal-admin.api';
import { LockedState } from './internal-admin.locked-state';
import type { AdminCredentials, ExportType } from './internal-admin.types';
    ...
    <section className="border-border bg-card rounded-lg border p-4" id="exports">
      <div className="mb-4">
        ...
        <p className="text-muted-foreground text-xs">
          Telechargement CSV inline depuis internal-admin-api.
        </p>
      </div>
