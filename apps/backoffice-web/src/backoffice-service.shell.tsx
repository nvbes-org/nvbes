...
const navItems = [
  ...
  { href: '#entitlements-center', label: 'Entitlements', icon: PackageCheck },
  { href: '#usage-center', label: 'Usage', icon: ChartNoAxesCombined },
  ...
  { href: '#risk-decision-center', label: 'Risk', icon: ShieldAlert },
...
export function BackofficeServiceShell({ children }: { children: ReactNode }) {
  return (
    <div className="bg-background text-foreground min-h-screen">
      <aside className="bg-sidebar text-sidebar-foreground border-sidebar-border fixed inset-y-0 left-0 hidden w-64 border-r lg:block">
        <div className="border-sidebar-border flex h-16 items-center gap-3 border-b px-5">
          ...
          <div>
            <div className="text-sm font-semibold">nvbes Backoffice</div>
