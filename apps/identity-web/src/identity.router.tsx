...
function lazyPage(
	loader: () => Promise<{ default: () => ReactElement | null }>,
) {
...
const LazyLandingPage = lazyPage(() => import("./pages/LandingPage"));
const LazyRegisterPage = lazyPage(() => import("./pages/RegisterPage"));
const LazyVerifyEmailPage = lazyPage(() => import("./pages/VerifyEmailPage"));
const LazyVerifyEmailResultPage = lazyPage(
	() => import("./pages/VerifyEmailResultPage"),
);
const LazyForgotPasswordPage = lazyPage(
	() => import("./pages/ForgotPasswordPage"),
);
const LazyResetPasswordPage = lazyPage(
	() => import("./pages/ResetPasswordPage"),
);
const LazyDeviceActivationPage = lazyPage(
	() => import("./pages/DeviceActivationPage"),
);
const LazyRecoveryReviewsPage = lazyPage(
	() => import("./pages/RecoveryReviewsPage"),
);
const LazyWorkerQueueStatusPage = lazyPage(
	() => import("./pages/WorkerQueueStatusPage"),
);
const LazyAccountPersonalInfoPage = lazyPage(
	() => import("./pages/AccountPersonalInfoPage"),
);
const LazyAccountSecurityPage = lazyPage(
	() => import("./pages/AccountSecurityPage"),
);
const LazyAccountPasswordPage = lazyPage(
	() => import("./pages/AccountPasswordPage"),
);
const LazyAccountSessionsPage = lazyPage(
	() => import("./pages/AccountSessionsPage"),
);
const LazyAccountPrivacyPage = lazyPage(
	() => import("./pages/AccountPrivacyPage"),
);
const LazyAccountLinkedAppsPage = lazyPage(
	() => import("./pages/AccountLinkedAppsPage"),
);
const LazyAccountAuditsPage = lazyPage(
	() => import("./pages/AccountAuditsPage"),
);
...
const LazyAccountSubscriptionsPage = lazyPage(
	() => import("./pages/AccountSubscriptionsPage"),
);
const LazyAccountNotificationsPage = lazyPage(
	() => import("./pages/AccountNotificationsPage"),
);
const LazyAccountPreferencesPage = lazyPage(
	() => import("./pages/AccountPreferencesPage"),
);
const LazyAccountStandingPage = lazyPage(
	() => import("./pages/AccountStandingPage"),
);
const LazyAccountSocialPage = lazyPage(
	() => import("./pages/AccountSocialPage"),
);
const LazyMfaPage = lazyPage(() => import("./pages/MfaPage"));
const LazyTotpSetupPage = lazyPage(() => import("./pages/TotpSetupPage"));
const LazyRecoveryCodesPage = lazyPage(
	() => import("./pages/RecoveryCodesPage"),
);
