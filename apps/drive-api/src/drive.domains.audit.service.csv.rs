...
pub fn events_to_csv(events: &[AuditEventView]) -> String {
    let mut csv = String::from(
        "id,workspace_id,created_at,actor_user_id,actor_principal_id,actor_email,action,target_type,target_id,ip,user_agent,geo_country_code,geo_network_kind,geo_risk_score,geo_risk_labels,metadata,previous_event_hash,event_hash\n",
    );
