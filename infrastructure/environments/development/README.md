...
Terraform/OpenTofu overlay for the nvbes Drive development environment.
...
- Managed PostgreSQL with private endpoint, encryption at rest and 3-day backup retention.
