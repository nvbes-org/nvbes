...
| C — refresh rotation, familles, concurrence et détection de rejeu                        | Familles PostgreSQL hashées et rotation atomique implémentées ; rejeu révoque famille/grant ; route HTTP refresh reste à monter                                                   |
