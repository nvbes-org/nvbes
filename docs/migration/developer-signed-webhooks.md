...
| Portal schema prevents duplicate replays per original delivery | passed | `apps/identity-service/migrations/0011_developer_portal.sql` |
| Console schema prevents duplicate replays per original delivery | passed | `apps/identity-service/migrations/0008_developer_console.sql` |
