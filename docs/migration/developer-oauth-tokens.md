...
| Check | Status | Path |
|---|---:|---|
| OpenAPI exposes OAuth client listing | passed | `apps/account-service/openapi.json` |
| OpenAPI exposes OAuth client creation | passed | `apps/account-service/openapi.json` |
| OpenAPI exposes OAuth client revocation | passed | `apps/account-service/openapi.json` |
| OpenAPI exposes OAuth client policy creation | passed | `apps/account-service/openapi.json` |
| OpenAPI exposes developer token inspection | passed | `apps/account-service/openapi.json` |
| OpenAPI export includes OAuth client handlers | passed | `apps/account-service/src/identity.http.openapi.rs` |
| OpenAPI export includes token inspection handler | passed | `apps/account-service/src/identity.http.openapi.rs` |
...
| Developer token inspection requires permission | passed | `apps/account-service/src/identity.domains.developer.tokens.routes.rs` |
| Developer console token debug records hash prefix only | passed | `apps/account-service/src/identity.domains.developer.routes.tokens.rs` |
| Backend token debug unit tests cover allowed, expired, and tenant mismatch | passed | `apps/account-service/src/identity.domains.developer.routes.tokens.tests.rs` |
| Developer console lists OAuth clients with consent and health status | passed | `apps/account-service/src/identity.domains.developer.routes.oauth.clients.rs` |
