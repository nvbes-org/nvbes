...
| drive | hash chain function | passed | `apps/cloud-service/migrations/0001_initial_schema.sql` |
| drive | hash partition | passed | `apps/cloud-service/migrations/0001_initial_schema.sql` |
| drive | sha256 digest | passed | `apps/cloud-service/migrations/0001_initial_schema.sql` |
| drive | previous hash included | passed | `apps/cloud-service/migrations/0001_initial_schema.sql` |
| drive | insert hash trigger | passed | `apps/cloud-service/migrations/0001_initial_schema.sql` |
| drive | insert trigger timing | passed | `apps/cloud-service/migrations/0001_initial_schema.sql` |
| drive | mutation blocker function | passed | `apps/cloud-service/migrations/0001_initial_schema.sql` |
| drive | update blocker trigger | passed | `apps/cloud-service/migrations/0001_initial_schema.sql` |
| drive | update trigger timing | passed | `apps/cloud-service/migrations/0001_initial_schema.sql` |
| drive | delete blocker trigger | passed | `apps/cloud-service/migrations/0001_initial_schema.sql` |
| drive | delete trigger timing | passed | `apps/cloud-service/migrations/0001_initial_schema.sql` |
| drive | unique event hash index | passed | `apps/cloud-service/migrations/0001_initial_schema.sql` |
