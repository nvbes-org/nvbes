...
- métadonnées de remise, d’échec, de désinscription et de sécurité des
  communications.
...
| `[PRESTATAIRE EMAIL À CONFIRMER]` | Communications transactionnelles | Sous-traitant | `[À COMPLÉTER]` |
