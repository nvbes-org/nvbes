...
export NVBES_ACCOUNT_SERVICE_BASE_URL="${NVBES_ACCOUNT_SERVICE_BASE_URL:-http://127.0.0.1:4000}"
export NVBES_DEVELOPER_ACCOUNT_CLIENT_ID="${NVBES_DEVELOPER_ACCOUNT_CLIENT_ID:-developer-service}"
export NVBES_DEVELOPER_ACCOUNT_CLIENT_SECRET="${NVBES_DEVELOPER_ACCOUNT_CLIENT_SECRET:-developer-service-secret-key-12345}"
