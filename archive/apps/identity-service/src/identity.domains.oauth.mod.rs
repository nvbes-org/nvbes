...
#[path = "identity.domains.oauth.authorization.subject.rs"]
pub(crate) mod authorization_subject;
...
pub mod flows;
#[path = "identity.domains.oauth.hosted.authorization.rs"]
pub mod hosted_authorization;
...
pub use logic::{generate_user_code, verify_client_secret_with_overlap};
pub use nvbes_product_identity::oauth::{hash_client_secret, verify_client_secret};
