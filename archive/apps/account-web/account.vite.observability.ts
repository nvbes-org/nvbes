type AccountEnvironmentSource = Record<string, string | undefined>;
...
export function resolveFaroUrl(envSources: readonly AccountEnvironmentSource[]): string {
...
function firstConfiguredValue(
  envSources: readonly AccountEnvironmentSource[],
