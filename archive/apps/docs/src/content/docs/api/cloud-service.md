---
title: API nvbes Cloud Service
description: Contrats OpenAPI, routes, paramètres et schémas pour nvbes Cloud Service (0.1.0).
---

> Source : `apps/cloud-service/openapi.json` • Version : `0.1.0` • Endpoints : **17**
