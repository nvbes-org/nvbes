...
import { type AccessReviewFilters, AccessReviewFilterControls } from './AccessReviewsPage.filters';
  ...
  return (
    <>
      ...
      <div className="mb-4 grid gap-2 sm:max-w-64">
        ...
        <Select
          value={targetRole}
          onValueChange={(value) => onTargetRoleChange(value as ChangeTargetRole)}
        >
