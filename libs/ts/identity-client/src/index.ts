...
export class IdentityClient {
	...
	revokeSession(sessionId: string): Promise<void> {
		return this.http
			.delete(`/auth/sessions/${sessionId}`, SuccessSchema)
			.then(() => undefined);
	}
	...
	revokeOtherSessions(): Promise<void> {
		return this.http
			.post("/auth/sessions/revoke-others", SuccessSchema, {})
			.then(() => undefined);
	}

	logout(): Promise<void> {
		return this.http
			.post("/auth/logout", SuccessSchema, {})
			.then(() => undefined);
	}
	...
	revokeOAuthClient(clientId: string): Promise<void> {
		return this.http
			.delete(`/oauth/clients/${clientId}`, SuccessSchema)
			.then(() => undefined);
	}
