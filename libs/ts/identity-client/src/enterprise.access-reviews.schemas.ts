...
export const CreateAccessReviewScheduleInputSchema = z.object({
	name: z.string().trim().min(1),
	description: z.string().trim().min(1).optional(),
...
function hasAccessReviewScope(
	scope: z.infer<typeof AccessReviewCampaignScopeInputSchema>,
) {
	return (
...
>;
export type AccessReviewSchedulesResponse = z.infer<
	typeof AccessReviewSchedulesResponseSchema
>;
export type AccessReviewCampaignDetail = z.infer<
	typeof AccessReviewCampaignDetailSchema
>;
export type AccessReviewCampaignExport = z.infer<
	typeof AccessReviewCampaignExportSchema
>;
export type AccessReviewCampaignExportRow = z.infer<
	typeof AccessReviewCampaignExportRowSchema
>;
export type AccessReviewDecisionInput = z.infer<
	typeof AccessReviewDecisionInputSchema
>;
export type AccessReviewDecisionResponse = z.infer<
	typeof AccessReviewDecisionResponseSchema
>;
export type CloseAccessReviewCampaignInput = z.infer<
	typeof CloseAccessReviewCampaignInputSchema
>;
export type CreateAccessReviewCampaignInput = z.infer<
	typeof CreateAccessReviewCampaignInputSchema
>;
export type CreateAccessReviewScheduleInput = z.infer<
	typeof CreateAccessReviewScheduleInputSchema
>;
