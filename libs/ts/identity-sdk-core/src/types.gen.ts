...
export interface components {
  schemas: {
    ...
    SecurityEventsResponse: {
      billing_webhook_events: components['schemas']['BillingWebhookEventView'][];
      next_before_billing_webhook_event?: string | null;
      /** Format: uuid */
      next_before_risk_event?: string | null;
      risk_events: components['schemas']['RiskEventView'][];
      /** Format: uuid */
      workspace_id: string;
    };
...
export interface operations {
  ...
  list_consents: {
    ...
    requestBody?: never;
    responses: {
      /** @description Active consents listed successfully */
      200: {
        headers: {
          [name: string]: unknown;
        };
