...
const zodJitlessBootstrapHash = "'sha256-MADsBPBvAfzKSGq+N7sBxSyONZL+4BuiYOfl+I7SpAE='";
export const strictTransportSecurity = 'max-age=63072000; includeSubDomains; preload';
...
export function productionTransportHeaders(mode: string): Readonly<Record<string, string>> {
  return mode === 'production' ? { 'Strict-Transport-Security': strictTransportSecurity } : {};
}
