...
import type { PostHogPurposeConsent } from './posthog.types';

export type PseudonymizePostHogId = (prefix: string, id: string) => Promise<string>;
...
export async function sanitizePostHogProperties(
  input: Record<string, unknown>,
  pseudonymize: PseudonymizePostHogId,
): Promise<Properties> {
...
export function normalizePostHogError(error: unknown): { name: string; message: string } {
