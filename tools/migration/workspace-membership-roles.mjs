...
function buildChecks() {
	return [
		...
		textCheck("audit-insert", sources.authzDb, "Permission denied decisions insert an audit event", "INSERT INTO audit_events"),
		textCheck("audit-action", sources.authzDb, "Permission denied audit uses stable action literal", "'permission.denied'"),
