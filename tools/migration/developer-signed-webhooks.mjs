...
const sources = {
  ...
  portalMigration: 'apps/identity-service/migrations/0011_developer_portal.sql',
  consoleMigration: 'apps/identity-service/migrations/0008_developer_console.sql',
