export const riskEvidence = {
	...
	"sessions-incompatibles": {
		...
		status: "mitigated",
		evidence:
			"apps/account-web/src/account.oauth.client.ts; apps/account-web/src/account.oauth.access-token.test.ts; apps/console-web/src/developer.session.ts; apps/console-web/src/__tests__/developer.session.test.ts",
		cutover_impact:
